...
if __name__ == "__main__":
    base_url = "http://ddockkkwl45kmnnd7b332qu4h3ov66e3zy2ytrpfarpswvtldcx3cvad.onion/category/software_forensics_tools"
    ...
    with open('resultsSoftwareForensicTools.csv', 'w', newline='', encoding='utf-8') as file:
